function gameStart() {
    ...
    document.getElementById("twos").addEventListener("touchstart",
   function () {
    check.checked = true;
    });
    function hell() {
   ...
   function com(ans) {
    ...
    // inner = ans.includes(cominneransbox[i].innerText); // in
   ...
   function change() {
    ...
    container.style.backgroundColor = `rgba(220, 82, 255,
   ${ranges.value})`;
   }
   change();
   function quits(points) {
    document.getElementById("quit").addEventListener("touchstart",
   function () {
